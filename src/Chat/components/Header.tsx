...
export const Header = ({nombre}:props) => {
  ...
  return (
    <header className='bg-[#222222] h-[120px] gap-2 flex w-[100%] justify-center items-center'>
        <div id='head-izquierda' className='w-[100%] md:w-[40%] h-[100%] flex justify-between items-center border-r-[1px] border-white'>
            ...
            <button type='button' onClick={onSalir} className='mr-2'>
                <img src={salir} className='w-[45px]' alt="" />
              </button>
        </div>
