...
export const RegisterPage = () => {
    ...
    const {onCreateUser,errorMessage,onClearErrorMessage,onSetErrorMessage}=useAuthStore();
         ...
         items-center">
           ...
           shadow-md flex flex-col justify-center items-center ${!errorMessage ? 'gap-3' : 'gap-2'}`}>
             ...
             <div className="w-[90%] flex justify-end items-center gap-1 pt-2">
                 ...
                 <Link to='/login' onClick={()=>onClearErrorMessage()} className="text-[#19CC39] underline font-medium">Login</Link>    
             </div>
           </form>
         </section>
